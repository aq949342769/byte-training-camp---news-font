<template>
  ...
  <van-cell-group class="center">
    <van-cell title="收藏内容" is-link @click="this.$router.replace('/my-fav-news')"></van-cell>
    <van-cell title="我的关注" is-link @click="this.$router.replace('/my-subscribe')"></van-cell>
    <van-cell title="我的点赞" is-link @click="this.$router.replace('/my-thumbs')"></van-cell>
  </van-cell-group>
  <van-cell-group>
